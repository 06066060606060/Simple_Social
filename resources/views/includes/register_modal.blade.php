        ...
        <div class="flex items-end justify-center min-h-screen px-4 text-center md:items-center sm:block sm:p-0">
            ...
            <div x-cloak x-show="modelOpen" x-transition:enter="transition ease-out duration-300 transform"
                ...
                <section class="bg-gray-50">  
                  ...
                  >
                    <h1 class="pt-4 mb-5 text-xl text-left text-gray-800 sm:text-center">Créer un compte</h1>
                    <form class="pb-1 space-y-4" action="/registration" method="post">
                        @csrf
                      ...
                      <div class="flex items-center justify-center">
                        <input type="submit" class="px-4 py-2 mx-1 space-x-2 text-sm tracking-wide text-white capitalize transition-colors duration-200 transform bg-gray-900 rounded-md hover:bg-gray-600 focus:outline-none focus:bg-gray-500 focus:ring focus:ring-gray-300 focus:ring-opacity-50" value="Register" />
                      </div>
                    </form>
                  </div>
                  </section>
