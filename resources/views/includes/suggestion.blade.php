...
<div class="flex flex-col md:flex-col lg:flex-row text-left pt-2 md:items-center">

        <img src=".{{ Storage::url($user->photo) }}" class="w-12 mx-4 rounded-full h-12 " alt="avatar" />
        <a class="p-0 m-1" href="">
            <p class="font-bold text-gray-400 hover:text-white">{{ $user->name }}</p>
        </a>
        <div class="flex justify-center w-full">
            <button class="px-2 lg:mt-4 h-6 text-[8px] md:text-[10px] mx-2 text-white transition duration-300 ease-in-out bg-blue-500 rounded hover:bg-blue-600">Ajouter</button>
