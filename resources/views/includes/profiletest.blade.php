...
<div class=" p-4  ">
    ...
    <article class="px-4  py-24 mx-auto max-w-7xl" itemid="#" itemscope itemtype="http://schema.org/BlogPosting">
            ...
            <div class="pb-6 mb-6 ">
                <div class="flex items-center my-4 border-t border-gray-200">
                    ...
                    <div>
                        ...
                        <p class="text-base  text-gray-500 lg:   "> Junary 18, 2021</p>
                    </div>
                </div>
        ...
        <div class="w-full mx-auto prose md:w-3/4 lg:w-1/2">
            ...
            <p class="my-4 page">[Chorus: Oliver Tree]
                Lifе goes on and on and on and on and on and
                On and on and on
        ...
        <div class="flex items-center w-full mx-auto mb-6 space-x-2 text-left md:w-3/4 lg:w-1/2">
            <p class="text-gray-600">Partager l'article </p>
