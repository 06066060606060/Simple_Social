    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-x-16 lg:gap-x-24 gap-y-20">
      <div>
        <div class="flex items-center justify-center w-12 h-12 mb-4 text-red-600 bg-red-100 rounded-full ">
            <img src="./img/avatar2.png" alt="Photo" class="w-12 h-12 pt-1 rounded-full">
        ...
        <h3 class="mb-2 text-base font-semibold leading-tight text-gray-900">Roaquim Smith</h3>
        <p class="text-sm text-gray-500">7 mars 1992</p>
        <p class="text-sm text-gray-500">Poissons</p>
        <p class="text-sm text-gray-500">Amis depuis 2ans</p>
      </div>
      <div>
