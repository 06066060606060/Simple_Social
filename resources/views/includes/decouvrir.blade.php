<section class="px-4 py-24 mx-auto max-w-7xl">
    ...
    <div class="grid grid-cols-1 gap-12 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3">
      <div>
        <a href="#">
          <img src="./img/monchat.jpg" class="object-cover w-full h-56 mb-5 bg-center rounded" alt="Kutty" loading="lazy" />
        </a>
        ...
        <p class="mb-3 text-sm font-normal text-gray-500">
          Lorem ipsum dolor sit, amet consectetur adipisicing elit. Ipsam, id. Quaerat , exercitationem totam minima?
        </p>
        {{-- <p class="mb-3 text-sm font-normal text-gray-500">
