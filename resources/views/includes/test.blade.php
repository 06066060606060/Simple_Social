<<<<<<< HEAD
<section class=" bg-gray-50" x-data="{ sideBar: false }">
    <nav class="absolute left-0 z-20 h-auto pb-10 my-3 overflow-x-hidden overflow-y-auto transition origin-left transform bg-gray-900 w-60 md:translate-x-0"
        :class="{ '-translate-x-full': !sideBar, 'translate-x-0': sideBar }" @click.away="sideBar = false"> <a href="/"
            class="flex items-center px-4 py-5"> <img src="./img/logo.png" alt="Kutty Logo" class="w-20" /> </a>
        <nav class="text-sm font-medium text-gray-500" aria-label="Main Navigation"> <a
                ...
                href="#"> <i class="fa-solid fa-house-chimney"></i></a> <a
                class="flex items-center px-4 py-3 transition cursor-pointer group hover:bg-gray-800 hover:text-gray-200"
                href="#"> <i class="fa-brands fa-facebook" id="github"></i> </a> <a
                ...
                href="#"> <i class="fa-brands fa-instagram" id="github"></i></a> <a
=======
...
<<<<<<< HEAD
                href="#"> <i class="fa-brands fa-twitter" id="github"></i> </a> <a
=======
                href="#"> <i class="fa-brands fa-github pr-4" id="github"></i> </a> <a
>>>>>>> a14975efd5b8d15c96681c02e64498258029ea0d
                class="flex items-center px-4 py-3 transition cursor-pointer group hover:bg-gray-800 hover:text-gray-200"
...
<<<<<<< HEAD
        <header class="flex items-center justify-between w-full px-4 h-14"> <button
                class="block btn btn-light-secondary md:hidden" @click.stop="sideBar = true"> <span
                    class="sr-only">Menu</span> <i class="fa-solid fa-magnifying-glass"></i> </button>
            ...
            <div class="flex items-center"> <a href="#" class="flex text-gray-500">  <i class="fa-solid fa-bell"></i> </a> <a href="#" class="ml-4 avatar avatar-sm"> <img src="./img/Ellipse2.png"
