<div class="mx-4 mt-1 bg-gray-100 max-w-7xl">
    <h1 class="p-4 mb-3 text-3xl font-bold text-center text-black md:leading-tight md:text-4xl">
        ...
        <div class="w-full mx-auto text-left bg-gray-100 lg:w-full md:text-center">
            <div class="" style="background-size: cover; height: 200px; width: 100%; background-repeat: no-repeat; background-image:url({{ Storage::url($user->banniere) }})">
                <div class="flex flex-row justify-center pt-8">
                    <img src="{{ Storage::url($user->photo) }}" class="w-24 h-24 mb-4 rounded-full" alt="Logo" />
                </div>
            </div>
