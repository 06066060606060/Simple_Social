                    ...
                    <div x-data="{ selected: 'option-1' }">
                            <div class="flex flex-row font-bold">
                                <div x-bind:class="{ 'bg-gray-200 pb-4 rounded-t text-black': selected === 'option-1' }">
                                    <span class="px-4" href="#option-1" x-on:click="selected = 'option-1'">Liste des Utilisateurs</span>
                                </div>
                                <div  x-bind:class="{ 'bg-gray-100 pb-4 rounded-t': selected === 'option-2' }">
                                    <span class="px-4" href="#option-2" x-on:click="selected = 'option-2'">Liste des Posts</span>
                                </div>
                            </div>
                                ...
                                <div class="container pt-2 mx-auto" x-data="loadUsers()">
                                    ...
                                    <div class="mt-4 grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                                        <template x-for="item in filteredUsers" :key="item">
                                            <div
                                                class="flex items-center shadow bg-gray-100 hover:bg-gray-100 hover:shadow-lg hover:rounded transition duration-150 ease-in-out transform hover:scale-105 p-3">
                                    ...
                                    <div class="w-full md:w-1/2 mx-auto py-6 flex justify-between items-center"
                                        ...
                                        <button x-on:click="viewPage(0)" :disabled="pageNumber == 0"
                                            ...
                                            <svg class="h-8 w-8 text-gray-600" width="24" height="24"
                                ...
                                <div class="container pt-2 mx-auto" x-data="loadPosts()">
                                    ...
                                    <div class="mt-4 grid grid-cols-1 md:grid-cols-1 lg:grid-cols-1 gap-4">
                                        <template x-for="item in filteredPosts" :key="item">
                                            <div class="flex flex-row justify-around shadow bg-gray-100 hover:bg-gray-100 hover:shadow-lg hover:rounded transition duration-150 ease-in-out transform hover:scale-105 p-3">
                                                <img class="w-24 h-auto mr-4"
                                                    :src="'./storage/' + `${item.image}`" />
                                                <div class="flex flex-col flex-start text-sm">
                                                    <span class="text-xs text-gray-400" x-text="item.user.name"></span>
                                                    <p class="text-gray-900 leading-none lg:w-[250px] w-150" x-text="item.content"></p>
                                                </div>
                                                <div class="flex flex-row">
